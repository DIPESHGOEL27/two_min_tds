...
class ChallanRecord(BaseModel):
    ...
    def to_excel_row(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "Tax_A": self.tax_breakup.tax_a,
            "Tax_B": self.tax_breakup.tax_b,
            "Tax_C": self.tax_breakup.tax_c,
            "Tax_D": self.tax_breakup.tax_d,
            "Tax_E": self.tax_breakup.tax_e,
            "Tax_F": self.tax_breakup.tax_f,
